...
import { usuarioService, atividadeService } from '../../services/supabaseService';
...
const HistoricoVendas: React.FC = () => {
  ...
  const carregarDados = async () => {
    ...
    try {
      ...
      const atividadesData = await atividadeService.getAtividades();
  ...
  const handleDeleteRegistro = async (registroId: string, e: React.MouseEvent) => {
    e.stopPropagation();
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-gray-800">Histórico - Vendas</h1>
        <p className="text-gray-600">Consulte os registros de atividades comerciais e vendas</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-800">Registros de Vendas</h2>
        ...
        <div className="p-6">
          {registros.length > 0 ? (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-1 lg:space-x-2 flex-shrink-0">
                        ...
                        {(user?.profile === 'admin' || user?.profile === 'gestor') && (
                          <div
                            onClick={(e) => handleDeleteRegistro(registro.id, e)}
                  ...
                  {registroSelecionado === registro.id && (
                    <div className="border-t border-gray-200 p-4 bg-gray-50">
                      <div className="space-y-6">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-gray-700 mb-3">Atividades Comerciais</h4>
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p className="text-gray-600">Os registros de vendas aparecerão aqui após serem criados</p>
            </div>
          )}
        </div>
